      ...
      <div className="mindfulness-page">
        ...
        <div className="tips-container">
          <div className="tip-card">
            ...
            <p>Take 5–10 minutes daily to focus on your breath and calm your mind. 🌬</p>
          </div>
          <div className="tip-card">
            <h3>Body Scan</h3>
            <p>Gently notice sensations from head to toe, releasing tension as you go. 🧘‍♀</p>
          </div>
          <div className="tip-card">
          ...
          <div className="tip-card">
            ...
            <p>Walk slowly, notice surroundings, and focus on each step. 🚶‍♂</p>
          </div>
        </div>
        ...
        <div className="tips-container">
          <div className="tip-card">
            ...
            <p>Write your feelings without judgment to release stress. ✍</p>
          </div>
          <div className="tip-card">
            <h3>Digital Detox</h3>
        ...
        <div className="tips-container">
          <div className="tip-card">
            <h3>Stretching</h3>
            <p>Start your day with gentle stretches to energize your body. 🤸‍♂</p>
          </div>
          <div className="tip-card">
            <h3>Balanced Diet</h3>
          ...
          <div className="tip-card">
            ...
            <p>Yoga, walking, or swimming helps both body and mind. 🏊‍♀🧘‍♂</p>
          </div>
        </div>
